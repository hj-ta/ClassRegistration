# ClassRegistration
## 프로젝트 개요
3단계로 구성된 강의 수강 신청 폼. 개인 신청과 단체 신청 모두 지원한다.

**라이브 데모**: https://class-registration-seven.vercel.app/

클론이나 설치 없이 브라우저에서 바로 확인 가능. 
MSW로 API를 모킹해 개인/단체 신청, 정원 초과, 중복 신청, 네트워크 에러까지 모든 시나리오를 체험할 수 있습니다.



진행 과정
개인적으로 화면 그리기보다 **조건부 필드, 스텝 간 데이터 정합성, 검증 시점 설계**가 중요하다고 생각하고 진행.
...
빠르게 확인하려면 [라이브 데모](https://class-registration-seven.vercel.app/)를 이용하세요.
